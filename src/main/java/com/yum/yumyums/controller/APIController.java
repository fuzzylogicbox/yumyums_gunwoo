...
public class APIController {
    ...
    @GetMapping("/verifyBusiness")
    public String verifyBusiness(@RequestParam String masterName, @RequestParam String sellerNum) {
        return sellerService.verifyBusiness(masterName, sellerNum);
    }
