...
public class MemberController extends ImageDefaultUrl {
    ...
    */
    ...
    @PostMapping("")
    public String memberSaveSubmit(MemberJoinRequest memberJoinRequest, @RequestParam("memberImg") MultipartFile multipartFile){
...
//            imgUrl = "member/"+memberDTO.getMemberId()+"/"+imgFile.getOriginalFilename();
            try {
                imgUrl = s3Uploader.upload(multipartFile, "member");
            } catch (IOException e) {
