...
const clusterer = new kakao.maps.MarkerClusterer({
    ...
    disableClickZoom: true, // 클러스터를 클릭했을 때 지도 확대 안 함
    calculator: [10, 30, 50] // 클러스터의 크기 단계
});
...
function loadStores(lat, lon, radius) {
    $.ajax({
        ...
        success: function(data) {
                    ...
                    const content = `
                        <div class="wrap">
                            <div class="info">
                                ...
                                <div class="body">
                                    <div class="img">
                                        <img src="${store.imagesDTO.imgUrl}" width="73" height="70">
                                    </div>
                                    <div class="desc">
            ...
            clusterer.addMarkers(markers); // 새로운 마커를 클러스터러에 추가
